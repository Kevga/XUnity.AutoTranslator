...
namespace UnityEngine.Events
{
   ...
   public sealed class UnityAction<T0, T1> : Il2CppSystem.MulticastDelegate
   {
      ...
      private static readonly System.IntPtr
         NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_T0_T1_AsyncCallback_Object_0;

      private static readonly System.IntPtr NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_IAsyncResult_0;

      public UnityAction( Il2CppSystem.Object @object, System.IntPtr method )
         : this(
            IL2CPP.il2cpp_object_new( (System.IntPtr)Il2CppClassPointerStore<UnityAction<T0, T1>>.NativeClassPtr ) )
      {
      }
      ...
      public static implicit operator UnityAction<T0, T1>( System.Action<T0, T1> obj0 ) =>
         DelegateSupport.ConvertDelegate<UnityAction<T0, T1>>( (System.Delegate)obj0 );
   }
#else
